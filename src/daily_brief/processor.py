...
- industry：判斷標準是「這則新聞對台股該產業的投資人是否有參考價值」，不看主角公司在哪裡——客戶訂單、供應鏈消息、技術競爭、產業趨勢、法規政策，只要影響台股該產業皆可收錄；積極從所有新聞來源掃描，有新聞的產業不要留空；每產業最多 4 則；**同一篇新聞的 link 只能出現在一個台股產業欄**；無相關新聞給空陣列 []；同一篇新聞可同時出現在 industry 和 us_industry（兩者去重獨立）
