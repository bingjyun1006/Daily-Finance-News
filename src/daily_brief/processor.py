...
- industry：收錄對台股該產業投資人有參考價值的台灣相關新聞，範疇包含：台灣個別公司動態（業績、訂單、擴產、新品、法說、外資調評）、產業整體趨勢、法規政策影響、券商／法人研究報告、專家產業評論；有參考價值就收，不要保守剔除；每產業上限 5 則；**同一篇新聞的 link 只能出現在一個台股產業欄，且不可與 us_industry 重複**；無相關新聞給空陣列 []
- us_industry：美國及國際公司（NVDA/AMD/ASML/Samsung/Micron 等）依產業歸類；有參考價值就收，不要保守剔除；每產業上限 4 則；**同一篇新聞的 link 只能出現在一個美股產業欄，且不可與 industry 重複**；無相關新聞給空陣列 []
